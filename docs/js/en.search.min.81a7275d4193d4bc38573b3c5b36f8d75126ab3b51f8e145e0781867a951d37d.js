...
input.addEventListener('focus',init);input.addEventListener('keyup',search);function init(){input.removeEventListener('focus',init);loadScript('/functional-testing-2/js/groupBy-62b30ac391.min.js');loadScript('/functional-testing-2/js/flexsearch-ad47a5e1ee.min.js',function(){const indexCfg={};const dataUrl="/functional-testing-2/en.search-data.min.json"
